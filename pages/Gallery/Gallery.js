...
const template = () => {
    ...
    <section>
        <div class="galeria">
                <div id="espana">
                    <h1>ESPAÑA</h1>
                    <a href="#switch-madrid"><h2 id="mad" class="rojo">Mad</h2></a>
                    <a href="#switch-valencia"><h2 id="vlc" class="blanco">Vlc</h2></a>
                    <a href="#switch-barcelona"><h2 id="bcn" class="blanco">Bcn</h2></a>
                    <a href="#switch-granada"><h2 id="grd" class="blanco">Grd</h2></a>
                </div>
                <div id="switches">
