...
export const templateMadrid = () => {
    ...
    <div class="photo">
        <div class="madridfoto1">
            <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/tuborojo.jpg" alt="coslada" data-img-show="0">
            <p>COSLADA</p>
        </div>
        <div class="madridfoto2">
            <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/djmon.jpg" alt="coslada" data-img-show="1">
            <p>COSLADA</p>
        </div>
        <div class="madridfoto3">
            <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/tubomain.jpg" alt="coslada" data-img-show="2">
            <p>COSLADA</p>
        </div>
        <div class="madridfoto4">
            <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/borrosa.jpg" alt="coslada" data-img-show="3">
            <p>COSLADA</p>
        </div>
        <div class="madridfoto5">
            <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/tubo2.jpg" alt="coslada" data-img-show="4">
            <p>COSLADA</p>
        </div>
    </div>
    </div>
