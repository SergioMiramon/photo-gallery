    ...
    <div id="vlc1" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto1">
                <img src="/assets/images/gallery/valenciafoto1.jpg" alt="ciutat de les arts i les ciènces" data-img-show="0">
                <p>CIUTAT DE LES ARTS I LES CIÈNCIES</p>
            </div>
            <div class="valenciafoto2">
                <img src="/assets/images/gallery/valenciafoto2.jpg" alt="peñiscola" data-img-show="1">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto3">
                <img src="/assets/images/gallery/valenciafoto3.jpg" alt="parque nacional de la albufera" data-img-show="2">
    ...
    <div id="vlc2" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto4">
                <img src="/assets/images/gallery/valenciafoto4.jpg" alt="peñiscola" data-img-show="3">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto5">
                <img src="/assets/images/gallery/valenciafoto5.jpg" alt="peñiscola" data-img-show="4">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto6">
                <img src="/assets/images/gallery/valenciafoto6.jpg" alt="parque nacional de la albufera" data-img-show="5">
                <p>PARQUE NACIONAL DE LA ALBUFERA</p>
            </div>
        </div>
    </div>
    <div id="vlc3" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto7">
                <img src="/assets/images/gallery/valenciafoto7.jpg" alt="valencia" data-img-show="6">
                <p>VALENCIA</p>
            </div>
            <div class="valenciafoto8">
                <img src="/assets/images/gallery/valenciafoto8.jpg" alt="peñiscola" data-img-show="7">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto9">
                <img src="/assets/images/gallery/valenciafoto9.jpg" alt="peñiscola" data-img-show="8">
                <p>PEÑISCOLA</p>
            </div>
        </div>
    </div>
