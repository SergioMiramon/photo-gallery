    ...
    <div id="vlc1" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto1">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto1.jpg" alt="ciutat de les arts i les ciènces" data-img-show="0">
                <p>CIUTAT DE LES ARTS I LES CIÈNCIES</p>
            </div>
            <div class="valenciafoto2">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto2.jpg" alt="peñiscola" data-img-show="1">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto3">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto3.jpg" alt="parque nacional de la albufera" data-img-show="2">
    ...
    <div id="vlc2" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto4">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto4.jpg" alt="peñiscola" data-img-show="3">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto5">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto5.jpg" alt="peñiscola" data-img-show="4">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto6">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto6.jpg" alt="parque nacional de la albufera" data-img-show="5">
                <p>PARQUE NACIONAL DE LA ALBUFERA</p>
            </div>
        </div>
    </div>
    <div id="vlc3" class="valenciacont">
        <div class="photo">
            <div class="valenciafoto7">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto7.jpg" alt="valencia" data-img-show="6">
                <p>VALENCIA</p>
            </div>
            <div class="valenciafoto8">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto8.jpg" alt="peñiscola" data-img-show="7">
                <p>PEÑISCOLA</p>
            </div>
            <div class="valenciafoto9">
                <img src="https://photo-gallery-git-master-sergiomiramon.vercel.app/assets/images/galeria/valenciafoto9.jpg" alt="peñiscola" data-img-show="8">
                <p>PEÑISCOLA</p>
            </div>
        </div>
    </div>
